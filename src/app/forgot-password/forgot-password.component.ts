...
export class ForgotPasswordComponent {
  private apiUrl = environment.apiUrl;
    ...
    constructor(private formBuilder:FormBuilder,private http: HttpClient,private router:Router,private renderer:Renderer2,private slogin:AuthService,private route:ActivatedRoute,public previousUrlService:LoginUrlService) {
    ...
    password() {
      ...
      this.http.get<any>(`${this.apiUrl}/registeredUser`)
        .subscribe(data => {
          ...
          if (user == null) {
            ...
            alert("verified!!");
            this.router.navigate(['/updatepassword'], { queryParams: { id: user.id } });
          }
        });
    }
    else{
